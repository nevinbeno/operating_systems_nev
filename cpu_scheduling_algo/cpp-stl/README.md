...
4. Repeat till all processes are completed.
    ...
    4.4. Else:
        4.4.1. Access the front element from the queue. 
        4.4.2. Decrement 1 unit of remaining time. 
        4.4.3. Increment time. 
        4.4.4. Calculate ct, rt, etc... if suitable.
        4.4.5. Increment "completed" if suitable. 
5. Display the specs
6. Stop. 
```